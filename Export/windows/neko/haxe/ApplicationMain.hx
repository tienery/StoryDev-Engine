...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Company Name", "MediaMintpaw38F6BA060EBECB39DropboxAncientDomainMintPawGameFiles", "com.example.mediamintpaw38f6ba060ebecb39dropboxancientdomainmintpawgamefiles", "1.0.0");
		...
		flash.Lib.create (function () {
			...
			"MediaMintpaw38F6BA060EBECB39DropboxAncientDomainMintPawGameFiles",
			null
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "MediaMintpaw38F6BA060EBECB39DropboxAncientDomainMintPawGameFiles", null, { width: 848, height: 480 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 848, height: 480 });
			#end
