...
@:access(openfl.Lib) class ApplicationMain {
	...
	public static function embed (elementName:String, width:Null<Int> = null, height:Null<Int> = null, background:String = null) {
		...
		//loaders.set("a/img/bg0.png", loader);
		total ++;
		...
		image.src = id;
		//var loader:Loader = new Loader();
		//loaders.set("a/img/char0.png", loader);
		total ++;
		...
		urlLoaders.set("a/info/commands.txt", urlLoader);
		total ++;
		...
		var urlLoader = new URLLoader ();
		urlLoader.dataFormat = BINARY;
		urlLoaders.set("a/info/events.json", urlLoader);
		total ++;
		...
		var urlLoader = new URLLoader ();
		urlLoader.dataFormat = BINARY;
		urlLoaders.set("a/info/passages.json", urlLoader);
		total ++;
		...
		var urlLoader = new URLLoader ();
		urlLoader.dataFormat = BINARY;
		urlLoaders.set("a/openfl.svg", urlLoader);
		total ++;
		
		
		
		var sound = Path.withoutExtension ("a/sound/test.mp3");
